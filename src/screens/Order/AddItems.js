...
const AddItems = () => {
  ...
  return (
   <SafeAreaView style={[MyStyle.container,{height:'100%', paddingBottom:'20%'}]}>
    <DropDownComponent value = {treatment} setValue = {setTreatment} placeholder = "Select The Treatment" label = "Select the Treatment Name" dropdownitems = {treatmentlist}/>
    <ScrollView>
    <View>
    ...
    <Button buttonname="Add to cart" disable = {disableButton} custombuttonstyle={{position:'absolute', bottom:30, width:'100%'}} function = {mycart}  />
